...
int64 nChainStartTime = 1461386462;
...
const string strMessageMagic = "Eorigincoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Eorigincoin
    bool fStrictPayToScriptHash = true; // Always active in Eorigincoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Eorigincoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "fWorkL Eore igig vector empty mapBlockIndex Eorigincoin";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 587526 : 587526;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
		assert(block.hashMerkleRoot == uint256("0xdbaf2cc9f4d112f7c5b0fd47c3c47c90767e0b1b9883209aed2fb2025ee331b9"));
...
unsigned char pchMessageStart[4] = { 0x1e, 0x5b, 0xf5, 0x3b };
